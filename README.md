...
pcall(function()
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "BusZy Hub Script",
        Text = "Script by BusZy\n!  Discord        BusZy#6178",
        Duration = 60
        }) 
end)
spawn(function()
...
local serv = win:Server("BusZy Hub", "")
...
local Misc40 = serv:Channel("Misc")
...
AFMain = _G.AutoFarm
Main40:Toggle("Auto Farm",_G.AutoFarm,function(state)
    _G.AutoFarm = state
    AFMain = state
end)
...
function CheckQuest()
	...
	if world3 then
        ...
        elseif Lv >= 2250 or SelectMonster == "Baking Staff [Lv. 2250]" then 
            ...
            TelePBoss(CFrameQ)
            elseif Lv >= 2300 and Lv <= 2325 or SelectMonster == "Cococa Warrior [Lv. 2300]" then 
            Ms = "Cococa Warrior [Lv. 2300]"
            NameQuest = "Chocolate Quest Giver 1"
            QuestLv = 1
            NameMon = "Cococa Warrior"
            CFrameQ = CFrame.new(-231.773239, 24.7600346, -12198.5283, 0.993564844, -2.31459314e-08, 0.113264799, 2.46066243e-08, 1, -1.14982255e-08, -0.113264799, 1.4211297e-08, 0.993564844)
            CFrameMon = CFrame.new(-43.097702, 54.1121941, -12313.3779, -0.233807832, 3.90991737e-08, 0.972282827, -8.52703366e-08, 1, -6.07190032e-08, -0.972282827, -9.71034595e-08, -0.233807832)
            TelePBoss(CFrameQ)
            elseif Lv >= 2325 and Lv <= 2350 or SelectMonster == "Chocolate Bar Battler [Lv. 2325]" then 
            Ms = "Chocolate Bar Battler [Lv. 2325]"
            NameQuest = "Chocolate Quest Giver 1"
            QuestLv = 2
            NameMon = "Chocolate Bar Battler [Lv. 2325]"
            CFrameQ = CFrame.new(-231.773239, 24.7600346, -12198.5283, 0.993564844, -2.31459314e-08, 0.113264799, 2.46066243e-08, 1, -1.14982255e-08, -0.113264799, 1.4211297e-08, 0.993564844)
            CFrameMon = CFrame.new(-780.453857, 75.2505569, -12734.7637, -0.9897663, 2.33122499e-08, -0.142697722, 2.64151634e-08, 1, -1.98502867e-08, 0.142697722, -2.34165292e-08, -0.9897663)
            TelePBoss(CFrameQ)
            elseif Lv >= 2350 and Lv <= 2375 or SelectMonster == "Sweet Thief [Lv. 2350]" then 
            Ms = "Sweet Thief [Lv. 2350]"
            NameQuest = "Chocolate Quest Giver 2"
            QuestLv = 2
            NameMon = "Sweet Thief [Lv. 2350]"
            CFrameQ = CFrame.new(-149.61615, 24.8196201, -12775.3105, -0.459036589, 6.70625155e-08, -0.888417363, -4.40572698e-08, 1, 9.82493304e-08, 0.888417363, 8.42412788e-08, -0.459036589)
            CFrameMon = CFrame.new(-91.7419586, 59.733078, -12702.3955, -0.512584925, 5.81044475e-08, 0.858636498, -4.01800477e-08, 1, -9.16570997e-08, -0.858636498, -8.14821064e-08, -0.512584925)
            TelePBoss(CFrameQ)
            elseif Lv >= 2375 or SelectMonster == "Candy Rebel [Lv. 2375]" then 
            Ms = "Candy Rebel [Lv. 2375]"
            NameQuest = "Chocolate Quest Giver 2"
            QuestLv = 2
            NameMon = "Candy Rebel [Lv. 2375]"
            CFrameQ = CFrame.new(-149.61615, 24.8196201, -12775.3105, -0.459036589, 6.70625155e-08, -0.888417363, -4.40572698e-08, 1, 9.82493304e-08, 0.888417363, 8.42412788e-08, -0.459036589)
            CFrameMon = CFrame.new(-74.21138, 24.8196526, -12929.1074, 0.976295888, -9.47837187e-09, -0.216440186, 1.1824028e-08, 1, 9.54248947e-09, 0.216440186, -1.18754873e-08, 0.976295888)
            TelePBoss(CFrameQ)
        end
    end
end
...
Main40:Toggle("RemoveEffect_and_Animetion",_G.FastAttack,function(state)
    _G.RemoveEffect = state
end)
...
Misc40:Label("Team Join")
Misc40:Button("Join Team Pirate",function()
    local args = {
        [1] = "SetTeam",
        [2] = "Pirates"
    }
...
Misc40:Button("Join Team Marine",function()
    local args = {
        [1] = "SetTeam",
        [2] = "Marines"
    }
...
Misc40:Label("Game")
Misc40:Button("Open Devil Shop",function()
    local args = {
        [1] = "GetFruits"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc40:Button("Open Color Haki",function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)

Misc40:Button("Open Title Name",function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc40:Button("Open AwakenToggle",function()
    local args = {
        [1] = "AwakeningChanger",
        [2] = "Check"
    }
...
Misc40:Textbox("Redeem at level ", _G.RedeemOnLv,false, function(value)
    _G.RedeemOnLv = value
...
Misc40:Toggle("Auto Redeem all codes", _G.AutoRedeem, function(state)
    _G.AutoRedeem = state
end)
spawn(function()
    while wait(5) do
...
Misc40:Line()
Misc40:Button("Fps Boost",function()
    FPSBOOT()
end)
Misc40:Toggle("No clip",false,function(state)
    Noclip = state
end)
